__pysys_title__   = r""" Heat: Sinus distribution in 1D """ 
#                        ==========================
__pysys_purpose__ = r""" Check the Heat 1D equation """ 
...
class PySysTest(ApesHelper, pysys.basetest.BaseTest):
    def setup(self):
        self.apes.setupAteles(atlfile='ateles_heat_1d.lua', sdrfile=None)
