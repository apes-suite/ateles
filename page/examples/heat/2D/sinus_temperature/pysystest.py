__pysys_title__   = r""" Heat: Sinus distribution in 2D """ 
#                        ==========================
__pysys_purpose__ = r""" Check the Heat 2D equation """ 
...
trackfile = 'simulation_track_temp_p00000.res'

from apes.apeshelper import ApesHelper
class PySysTest(ApesHelper, pysys.basetest.BaseTest):
    def setup(self):
        self.apes.setupAteles(atlfile='ateles_heat_2d.lua', sdrfile=None)
