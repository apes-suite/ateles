__pysys_title__   = r""" Linear Euler: transient background """ 
#                        ==========================
__pysys_purpose__ = r""" Check for the linear Euler equations with a transient background state """ 
...
trackfile = 'lineareuler_transientBackground_p00000.res'
