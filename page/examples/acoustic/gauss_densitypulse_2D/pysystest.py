__pysys_title__   = r""" Acoustic: 2D Gaussian Pulse in Density """
#                        ==========================
__pysys_purpose__ = r""" Check the 2D Acoustic equations with a density pulse """
...
trackfile = 'simulation_track_density_p00000.res'

from apes.apeshelper import ApesHelper
class PySysTest(ApesHelper, pysys.basetest.BaseTest):
    def setup(self):
        self.apes.setupAteles(atlfile='acoustic_modg_2d_recheck.lua', sdrfile=None)
