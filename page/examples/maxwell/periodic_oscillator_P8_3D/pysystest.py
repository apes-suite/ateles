__pysys_title__   = r""" Maxwell: P8 Periodic Oscillator """ 
#                        ==========================
__pysys_purpose__ = r""" Check for the Maxwell equations with a periodic oscillator and P8 polynomials """ 
...
trackfile = 'posci_modgP8_probe_electricField_P8_p00000.res'
...
class PySysTest(ApesHelper, pysys.basetest.BaseTest):
    def setup(self):
        ...
        self.apes.setupAteles(atlfile='ateles_P8_valid.lua', sdrfile=None)
