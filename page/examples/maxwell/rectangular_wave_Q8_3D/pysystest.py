__pysys_title__   = r""" Maxwell: Q8 Rectangular wave guide """ 
#                        ==========================
__pysys_purpose__ = r""" Check for the Maxwell equations with a rectangular wave guide and Q8 polynomials """ 
...
trackfile = 'rectang_waveguide_maxwell_modg_probe_electricField_Q8_p00000.res'

from apes.apeshelper import ApesHelper
class PySysTest(ApesHelper, pysys.basetest.BaseTest):
    def setup(self):
        self.apes.setupAteles(atlfile='ateles_maxwell_modg_valid.lua')
