__pysys_title__   = r""" Maxwell Divergence Correction: P8 Periodic Oscillator """ 
#                        ==========================
__pysys_purpose__ = r""" Check for the Maxwell equations with Divergence Correction with a periodic oscillator and P8 polynomials """ 
...
trackfile = 'maxwell_divcor_probe_electricField_P8_p00000.res'

from apes.apeshelper import ApesHelper
class PySysTest(ApesHelper, pysys.basetest.BaseTest):
    def setup(self):
        self.apes.setupAteles(atlfile='ateles_divcor_p.lua', sdrfile=None)
