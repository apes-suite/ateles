__pysys_title__   = r""" Maxwell Divergence Correction: Q8 Periodic Oscillator """ 
#                        ==========================
__pysys_purpose__ = r""" Check for the Maxwell equations with Divergence Correction with a periodic oscillator and Q8 polynomials """ 
...
trackfile = 'maxwell_source_divcor_source_probe_electricField_Q8_p00000.res'

from apes.apeshelper import ApesHelper
class PySysTest(ApesHelper, pysys.basetest.BaseTest):
    def setup(self):
        self.apes.setupAteles(atlfile='ateles_source_Q8_recheck.lua', sdrfile='seeder_source.lua')
        self.deleteFile(trackfile)

    def execute(self):
        atlrun = self.apes.runAteles(np = 6)
