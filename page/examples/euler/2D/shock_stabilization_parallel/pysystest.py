__pysys_title__   = r""" 2D Covolume stabilization with RK Taylor (parallel) """
#                        ==========================
__pysys_purpose__ = r""" Check the parallel execution with shock stabilization in 2D """
...
trackfile = 'euler_2d_probe_density_Q4_covolume_rktaylor_y_p00000.res'
