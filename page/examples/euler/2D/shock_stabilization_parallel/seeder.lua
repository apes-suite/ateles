...
nelems = 8 --os.getenv('nelem')         -- number of elements through the channel
...
spatial_object = {
  { attribute = { kind = 'seed' },
    geometry = { kind = 'canoND', object = { origin = { channel_width/2.0,
                                                        channel_length/2.0,
                                                        channel_width/2.0
                                                      }
                                           }
  ...
  { attribute = { kind = 'boundary', label = 'inlet', level = reflevel },
    geometry = { kind = 'canoND',
                 object = { origin = { -epsx, -epsx, -epsx },
                            vec = { { channel_width+2*epsx, 0.0, 0.0 },
  ...
  { attribute = { kind = 'boundary', label = 'outlet', level = reflevel },
    geometry = { kind = 'canoND',
                 object = { origin = { -epsx, channel_length+epsx, -epsx },
                            vec = { { channel_width+2*epsx, 0.0, 0.0 },
                                    { 0.0, 0.0, channel_width+2*epsx }
                                  }
                          }
  ...
  { attribute = { kind = 'boundary', label = 'south', level = reflevel },
    geometry = { kind = 'canoND',
                 object = { origin = { -epsx, -epsx, -epsx },
                            vec = { { 0.0, channel_length+2*epsx, 0.0 },
                                    { 0.0, 0.0, channel_width+2*epsx }
                                  }
                          }
               }
  ...
  { attribute = { kind = 'boundary', label = 'north', level = reflevel },
    geometry = { kind = 'canoND',
                 object = { origin = { channel_width+epsx, -epsx, -epsx },
                            vec = { { 0.0, channel_length+2*epsx, 0.0 },
                                    { 0.0, 0.0, channel_width+2*epsx }
                                  }
                          }
