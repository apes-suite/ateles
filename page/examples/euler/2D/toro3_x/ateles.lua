-- Toro3 setup solving a Riemann problem in the Euler 2D equations.
...
--
-- The Riemann problem prescribed here defines a very strong jump in pressure in
-- a fluid at rest.

-- global simulation options
simulation_name = 'toro3_euler_modg_2d'
sim_control = {
  time_control = {
    min = 0,
    max = 0.0012
