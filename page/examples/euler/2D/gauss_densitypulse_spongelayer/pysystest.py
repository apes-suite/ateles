__pysys_title__   = r""" Euler: 2D Gaussian Pulse in Density with sponge """
#                        ==========================
__pysys_purpose__ = r""" Check the sponge layer in Euler equations """
...
trackfile = 'sponge_2d_modg_sponge_2d_p00000.res'
