__pysys_title__   = r""" Euler: Toro setup in 2D in Y """ 
#                        ==========================
__pysys_purpose__ = r""" Check for the Euler equations with a Riemann problem in 2D in Y """ 
...
trackfile = 'toro1_y_euler_modg_2d_probe_density_Q4_toro_y_p00000.res'
