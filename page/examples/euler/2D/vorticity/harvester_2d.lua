...
input = {
         ...
         --read = './restart_2d/simulation_header_0.000E+00.lua',
         read = './tracking/simulation_euler_2d_conservative_vort_simulation_header_0.000E+00.lua',
...
output = {  -- some general information
            folder = './harvest_2d/',     -- Output location 

           {

            --requestedData = { variable = {{'velocity'},{'density'},{'kinetic_energy'} }},    
            --requestedData = {variable = {'vorticity'}},    
           -- requestedData = {variable = {{'vorticity'},{'velocity'},{'density'},{'momentum'}}},    
            --requestedData = {variable = {{'density'},{'momentum'},{'kinetic_energy'}}},    
