__pysys_title__   = r""" Covolume stabilization with local refinement """
#                        ==========================
__pysys_purpose__ = r""" Check the shock stabilization with local refinement """
...
trackfile = 'euler_3d_probe_density_covolume_multilevel_p00000.res'
