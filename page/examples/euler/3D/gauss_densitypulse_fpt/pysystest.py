...
__pysys_title__   = r""" Euler: Gaussian Pulse in Density FPT """
#                        ==========================
__pysys_purpose__ = r""" Check for the Euler equations with Gaussian Pulse and FPT """
...
trackfile = 'gPulseDens_euler_modg_track_momentum_p00000.res'
