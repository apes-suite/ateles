__pysys_title__   = r""" Euler: Gaussian Pulse in Density FXT """
#                        ==========================
__pysys_purpose__ = r""" Check for the Euler equations with Gaussian Pulse and FXT """
...
trackfile = 'gPulseDens_euler_fxt_track_momentum_fxt_p00000.res'
