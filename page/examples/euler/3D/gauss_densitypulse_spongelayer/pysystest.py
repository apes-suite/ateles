__pysys_title__   = r""" Euler: Gaussian Pulse in Density with sponge """
#                        ==========================
__pysys_purpose__ = r""" Check the spong layer in Euler equations """
...
trackfile = 'sponge_layer_modg_sponge_p00000.res'
