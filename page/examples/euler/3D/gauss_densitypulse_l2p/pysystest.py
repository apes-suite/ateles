__pysys_title__   = r""" Euler: Gaussian Pulse in Density L2P """
#                        ==========================
__pysys_purpose__ = r""" Check for the Euler equations with Gaussian Pulse and L2P """
...
trackfile = 'gPulseDens_euler_modg_track_momentum_l2p_p00000.res'
