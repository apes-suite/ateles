__pysys_title__   = r""" Euler: Q4 Shear layer parallel""" 
#                        ==========================
__pysys_purpose__ = r""" Check for the Euler equations with a shear layer and Q4 polynomials (parallel)""" 
...
trackfile = 'shear_layer_modg_probe_momentum_Q4_p00000.res'
