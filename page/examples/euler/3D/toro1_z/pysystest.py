__pysys_title__   = r""" Euler: Toro setup in 3D in Z """
#                        ==========================
__pysys_purpose__ = r""" Check for the Euler equations with a Riemann problem in 3D in Z """
...
trackfile = 'toro1_z_euler_modg_probe_density_Q4_toro_z_p00000.res'
