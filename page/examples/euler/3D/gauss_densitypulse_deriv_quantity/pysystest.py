__pysys_title__   = r""" Euler: Gaussian Pulse in Density derived quantity """
#                        ==========================
__pysys_purpose__ = r""" Check for the Euler equations with Gaussian Pulse derived quantity """
...
trackfile = 'gPulseDens_euler_modg_track_ke_p00000.res'
