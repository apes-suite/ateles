__pysys_title__   = r""" 1D Covolume stabilization with RK Taylor (parallel) """
#                        ==========================
__pysys_purpose__ = r""" Check the parallel execution with shock stabilization in 1D """
...
trackfile = 'euler_1d_probe_density_Q4_covolume_rktaylor_x_p00000.res'
